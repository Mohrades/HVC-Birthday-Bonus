...
public class HVConsumerItemListener extends ItemListenerSupport<HVConsumer, HVConsumer> {

	private DAO dao;

	private ProductProperties productProperties;

	public HVConsumerItemListener() {
	...
	public void beforeProcess(HVConsumer item) {
		
	}

	public void beforeWrite(List<? extends HVConsumer> result) {
	...
	public void onProcessError(HVConsumer item, Exception ex) {
		
	}

	public void onWriteError(Exception ex, List<? extends HVConsumer> result) {
		
	}

	public void afterRead(HVConsumer item) {
		
	}

	public void afterProcess(HVConsumer item, HVConsumer result) {
		
	}

	public void afterWrite(List<? extends HVConsumer> result) {
