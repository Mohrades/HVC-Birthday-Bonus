											...
											if((((element.getAttributeValue("min") != null) && (number < Long.parseLong(element.getAttributeValue("min")))) || ((element.getAttributeValue("max") != null) && (number > Long.parseLong(element.getAttributeValue("max")))))) {
												if(children.size() == 1) {
													if((element.getAttributeValue("min") != null) && (element.getAttributeValue("max") != null)) {
														return handleInvalidInput(i18n.getMessage("integer.range", new Object[] {Long.parseLong(element.getAttributeValue("min")), Long.parseLong(element.getAttributeValue("max"))}, null, (hvc.getLanguage() == 2) ? Locale.ENGLISH : Locale.FRENCH));
													}
													else if(element.getAttributeValue("min") != null) {
														return handleInvalidInput(i18n.getMessage("integer.min", new Object[] {Long.parseLong(element.getAttributeValue("min"))}, null, (hvc.getLanguage() == 2) ? Locale.ENGLISH : Locale.FRENCH));
													}
													else if(element.getAttributeValue("max") != null) {
														return handleInvalidInput(i18n.getMessage("integer.max", new Object[] {Long.parseLong(element.getAttributeValue("max"))}, null, (hvc.getLanguage() == 2) ? Locale.ENGLISH : Locale.FRENCH));
													}
												}
											}
											else {
